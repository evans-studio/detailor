...
function CustomerCard({ customer, onCustomerClick, onBookService, onCustomerEdit }: {
  ...
  return (
    <Card className="group hover:shadow-[var(--shadow-md)] transition-all duration-[var(--duration-normal)] cursor-pointer border-[var(--color-border)] hover:border-[var(--color-primary)]/30" data-testid={`customer-card-${customer.id}`}>
      <CardContent className="p-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-[var(--font-size-sm)] text-[var(--color-text-muted)] space-y-1">
              {customer.email && <div className="flex items-center gap-1">
                ...
                <span className="truncate" data-testid="customer-email">{customer.email}</span>
              </div>}
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <div className="text-[var(--font-size-lg)] font-[var(--font-weight-bold)] text-[var(--color-text)]" data-testid="customer-total-spent">
          ...
          <div>
            ...
            <div className="text-[var(--font-size-lg)] font-[var(--font-weight-bold)] text-[var(--color-text)]" data-testid="customer-total-bookings">
