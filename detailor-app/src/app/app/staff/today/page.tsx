                  ...
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="text-right">
                      <div className={`inline-block px-2 py-1 rounded-[var(--radius-sm)] text-[var(--font-size-xs)] font-medium ${
                        j.status === 'not_started' ? 'bg-[var(--color-warning-100)] text-[var(--color-warning-600)]' :
                        j.status === 'in_progress' ? 'bg-[var(--color-primary-100)] text-[var(--color-primary-700)]' :
                        j.status === 'completed' ? 'bg-[var(--color-success-100)] text-[var(--color-success-600)]' : 'bg-[var(--color-muted)] text-[var(--color-text)]'
                      }`}>
